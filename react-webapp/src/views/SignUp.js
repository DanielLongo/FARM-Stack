            ...
            <div className='flex flex-row items-center justify-around mb-12'>
                <div className='px-12'>
                    ...
                    <hr class="mx-auto my-6 w-48 h-1 bg-gray-100 rounded border-0 dark:bg-gray-700"/>
                        ...
                        <button onClick={hanldeSignUp} className="p-2 mb-4 w-full font-semibold bg-transparent border-[1px] border-black rounded-lg hover:bg-gray-200 hover:text-gray-700 mt-4">
                            Sign Up
                        </button>
                </div>
            </div>
