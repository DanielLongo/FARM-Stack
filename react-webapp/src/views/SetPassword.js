    ...
    <Modal onClose={onClose}>
        ...
        className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all w-11/12 max-w-md">
            ...
            <div className='flex flex-row items-center justify-around mb-16'>
                <div className='px-12'>
                    <h1 className="text-2xl text-center font-bold text-left mb-8">Set Password</h1>
                    <label className='text-xs font-semibold' for="email">Reset Code</label> 
                    <input
                        value={code}
                    ...
                    />
                    <label className='text-xs font-semibold' for="password">New Password</label> 
                    <input
                        value={newPassword}
                    ...
                    />
                    <button onClick={handleSetPassword} className="mb-4 mt-6 btn-primary w-full">
                        Reset Password
                    </button>
