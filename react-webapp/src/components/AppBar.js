...
function AppBar(props) {
  ...
  const showLogin = () => { setAuthModalType("login") }
  const showSignUp = () => { setAuthModalType("signup") }
        ...
        <div>
          {
            isAuthed ? (
              ...
              <div>
                <div className="flex flex-row">
                  <button className="btn-secondary" onClick={showLogin}>Login</button>
                  <span className="w-2"></span>
                  <button className="btn-primary" onClick={showSignUp}>Sign Up</button>
                </div>
              </div>
            )
          }
