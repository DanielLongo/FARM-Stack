    ...
    return (
        ...
        <div>
          ...
          <div>
            ...
            {!dashboardPages.includes(window.location.pathname) && <button onClick={() => navigate("/home")} className="btn-primary"> To Dashboard </button>}
          </div>
          :
        <div>
          ...
          <button onClick={props.showSignUp} className="btn-primary">
            Sign Up
          </button>
          </div>
}
