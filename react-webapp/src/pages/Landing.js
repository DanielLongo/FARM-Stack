          ...
          <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto text-center">
              <h2 class="text-2xl font-bold text-gray-800 sm:text-4xl sm:leading-tight">
                Trusted by world class companies, design teams & popular
                designers
              </h2>
            </div>
              ...
              <div class="overflow-hidden bg-white border-2 border-gray-100 rounded-md">
                <div class="p-8 xl:px-12">
                  ...
                  <a
                    href="#"
                    title=""
                    class="inline-flex items-center justify-center px-10 py-4 mt-10 text-base font-semibold text-white transition-all duration-200 bg-blue-800 rounded-md hover:bg-blue-900 focus:bg-blue-900"
                    role="button"
                  >
                    {" "}
                    Get full access{" "}
              ...
              <div class="overflow-hidden bg-white border-2 border-gray-100 rounded-md shadow-lg">
                <div class="p-8 xl:px-12">
                  ...
                  <a
                    href="#"
                    title=""
                    class="inline-flex items-center justify-center px-10 py-4 mt-10 text-base font-semibold text-white transition-all duration-200 rounded-md bg-gradient-to-r from-fuchsia-600 to-blue-800 hover:opacity-80 focus:opacity-80"
                    role="button"
                  >
                    {" "}
                    Get full access{" "}
        ...
        <section class="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
          <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
              ...
              <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" class="mt-6">
                  ...
                  <button
                    type="submit"
                    class="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-blue-800 rounded-md hover:bg-blue-700 focus:bg-blue-900"
                  >
                    Subscribe
                  </button>
                </form>
            ...
            <p class="text-sm text-center text-gray-600">
              © Copyright 2023, All Rights Reserved by [COMPANY NAME]
            </p>
          </div>
        </section>
      </div>
